...
# Define the Google Drive file IDs and local paths
GDRIVE_FILES = {
    "similarity_matrix": "1NCYJ22qn9GpikDJERacirjeMz4UmOlUP",
    "pipeline": "1Fl3bTahFNUYMsCogRPF2HQCWV5cVGPgi",
    "df": "1b06-nr2pdFLxzEIV9FbzTu3K04jipfP3"
}
LOCAL_FILES = {
...
def load_resources():
    ...
    recommendation_data = pd.read_csv("data/processed/Recommendation_data.csv").dropna()
